    ...
    static async toggleOnlineOrdering(req, res, next) {
        try {
            ...
            if (isEnabled && !restaurant.onlineSlug) {
                ...
                updateData.onlineSlug = await PublicController.generateUniqueSlug(restaurant_model_1.Restaurant, baseSlug, 'onlineSlug');
            }
            const updated = await restaurant_model_1.Restaurant.findByIdAndUpdate(restaurant._id, { $set: updateData }, { new: true });
            res.status(200).json({
                success: true,
                data: updated
            });
    ...
    static async toggleWaiterOrdering(req, res, next) {
        try {
            ...
            if (isEnabled && !restaurant.waiterSlug) {
                ...
                updateData.waiterSlug = await PublicController.generateUniqueSlug(restaurant_model_1.Restaurant, baseSlug, 'waiterSlug');
            }
            const updated = await restaurant_model_1.Restaurant.findByIdAndUpdate(restaurant._id, { $set: updateData }, { new: true });
            res.status(200).json({
                success: true,
    ...
    static async toggleBillingOrdering(req, res, next) {
        try {
            ...
            if (isEnabled && !restaurant.billingSlug) {
                ...
                updateData.billingSlug = await PublicController.generateUniqueSlug(restaurant_model_1.Restaurant, baseSlug, 'billingSlug');
            }
            const updated = await restaurant_model_1.Restaurant.findByIdAndUpdate(restaurant._id, { $set: updateData }, { new: true });
            res.status(200).json({
                success: true,
    ...
    static async toggleKds(req, res, next) {
        try {
            ...
            if (isEnabled && !restaurant.kdsSlug) {
                ...
                updateData.kdsSlug = await PublicController.generateUniqueSlug(restaurant_model_1.Restaurant, baseSlug, 'kdsSlug');
            }
            const updated = await restaurant_model_1.Restaurant.findByIdAndUpdate(restaurant._id, { $set: updateData }, { new: true });
            res.status(200).json({
                success: true,
    ...
    static async toggleInventory(req, res, next) {
        try {
            ...
            if (isEnabled && !restaurant.inventorySlug) {
                ...
                updateData.inventorySlug = await PublicController.generateUniqueSlug(restaurant_model_1.Restaurant, baseSlug, 'inventorySlug');
            }
            const updated = await restaurant_model_1.Restaurant.findByIdAndUpdate(restaurant._id, { $set: updateData }, { new: true });
            res.status(200).json({
                success: true,
